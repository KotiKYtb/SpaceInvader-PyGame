...
police_écrature = pygame.font.Font("SpaceInvader/SpaceInvaderIMG/DS-DIGII.TTF", 32)
...
class Vaisseau(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, life, point=0, cooldown_spawn=0, vitesse_joueur=5, cooldown=1):
...
while start:    #Tant que start à pour valeur True et bien la boucle continue de fonctionner
    ...
    if vaisseau.cooldownspawn == 24:
        ...
        print("FPS :" + str(fps))
        print("Vitesse : " + str(vaisseau.vitesse_joueur))
    else:
        pass
